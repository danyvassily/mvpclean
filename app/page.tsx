...
export default function HomePage() {
  ...
  useGSAP(
    () => {
      // Animation parallax pour l'image hero uniquement
      gsap.fromTo(
        heroImage.current,
        { scale: 1.2, y: "-5%" },
        {
    ...
    <div ref={container} className="min-h-screen">
      ...
      <section className="relative h-[85vh] min-h-[600px] max-h-[900px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 sm:px-8 lg:px-16">
          ...
          {/* Bouton CTA centré juste en dessous */}
          <div className="w-full flex justify-center">
            <Button
              asChild
              className="bg-white text-slate-900 border-white hover:bg-white/90 px-6 sm:px-8 py-3 sm:py-4 text-xs sm:text-sm font-medium tracking-widest uppercase transition-colors"
            >
